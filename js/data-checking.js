...
<svg 
  ...
  `})(this._options);this._elem.insertAdjacentHTML("beforeend",e),this._svg=this._elem.querySelector(n.svg),this._svgCircle=this._elem.querySelector(n.circle),this._svgProgressbar=this._elem.querySelector(n.progressbar),this._setTextSize()};_init=()=>{this._elem&&(this._setProgress(),this._render())}}const s=document.body.offsetWidth<=768,d={size:s?210:275,valueToggle:!0,percentageToggle:!0,circleColor:"#F3F3F3",progressColor:"#311571",textColor:"#311571",circleWidth:15,progressWidth:15,textSize:{width:0,height:0,fontSize:s?50:65}};return document.addEventListener("DOMContentLoaded",e=>{if(i&&a&&l&&c){if(i&&a&&l&&c){let t=!1;window.addEventListener("scroll",()=>{var e=i.offsetHeight;!t&&scrollY>e?(t=!0,i.classList.add("header_fixed")):t&&scrollY<e&&(t=!1,i.classList.remove("header_fixed"))})}a.addEventListener("click",()=>{i.classList.toggle("active"),a.classList.toggle("active"),l.classList.toggle("active"),c.classList.toggle("active"),document.body.classList.toggle("no-scroll")}),c.addEventListener("click",()=>{i&&a&&l&&c&&(i.classList.remove("active"),a.classList.remove("active"),l.classList.remove("active"),c.classList.remove("active"),document.body.classList.remove("no-scroll"))})}var r=document.body.querySelector(".data-checking__loader");if(r){console.log(d);const s=new g(r,d);let t=Date.now();const o=setInterval(()=>{var e=Date.now()-t,e=(6e3<=e&&clearInterval(o),Math.floor(e/6e3*100));s.setProgress(e)},40)}}),t}()});